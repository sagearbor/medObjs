      ...
      <div class="panel-body">
        <div class="row">
          <?php
            ...
            $disciplines2 = $conn->prepare("SELECT discipline FROM objectives WHERE inDB = 1");
            $disciplines = $conn->prepare("SELECT displayName FROM objectives WHERE inDB = 1");
            $disciplines2->execute();
            ?>
            <?php foreach($disciplines2->fetchAll(PDO::FETCH_ASSOC) as $row) : ?>
          <div class="col-lg-6">
            <div class="input-group">
              <span class="input-group-addon">
                <input type="checkbox" checked aria-label="...">
